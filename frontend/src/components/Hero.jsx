      ...
      <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center justify-between gap-14">
        ...
        <div className="max-w-2xl text-center lg:text-left">
          ...
          <div className="mt-10 flex flex-wrap justify-center lg:justify-start gap-4">
            ...
            <button className="border border-blue-600 text-blue-700 hover:bg-blue-50 hover:scale-105 transition-all duration-300 px-7 py-3 rounded-xl font-semibold">
              View Rooms
            </button>
        ...
        <div className="relative w-full flex justify-center">
          ...
          <div className="relative bg-white rounded-3xl shadow-2xl p-8 w-full max-w-md hover:-translate-y-2 transition-all duration-300">
